...
app.get('/users', function (req, res) {
  req.app.get('db').query(
    ...
    res.json(tests)// all tests matching the criteria
  });
});
...
app.get('/notsafe/products', function (req, res, next) {
...
// http://localhost:3000/notsafe/products/?name=%27%20or%201=%271
// http://localhost:3000/notsafe/products/?name=' or 1='1
