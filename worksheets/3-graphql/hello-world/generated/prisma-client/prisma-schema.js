...
type Reorder {
  id: ID!
  prod_id(where: ProductWhereInput, orderBy: ProductOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [Product!]
  date_low: DateTime
  quan_low: Int
...
input ReorderCreateInput {
  prod_id: ProductCreateManyInput
  date_low: DateTime
  quan_low: Int
  date_reordered: DateTime
  quan_reordered: Int
...
input ReorderUpdateInput {
  prod_id: ProductUpdateManyInput
  date_low: DateTime
  quan_low: Int
  date_reordered: DateTime
  quan_reordered: Int
...
input ReorderWhereInput {
  ...
  id_ends_with: ID
  id_not_ends_with: ID
  prod_id_every: ProductWhereInput
  prod_id_some: ProductWhereInput
  prod_id_none: ProductWhereInput
  date_low: DateTime
