...
input OrderlineWhereInput {
  ...
  orderlineid_not: ID
  orderlineid_in: [ID!]
  orderlineid_not_in: [ID!]
  orderlineid_lt: ID
  orderlineid_lte: ID
  orderlineid_gt: ID
  orderlineid_gte: ID
  orderlineid_contains: ID
  orderlineid_not_contains: ID
  orderlineid_starts_with: ID
  orderlineid_not_starts_with: ID
  orderlineid_ends_with: ID
  orderlineid_not_ends_with: ID
  product: ProductWhereInput
  quantity: Int
  quantity_not: Int
  quantity_in: [Int!]
